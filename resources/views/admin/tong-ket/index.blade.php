...
<div class="container-fluid py-4">
    <div class="card">
        <div class="card-header bg-primary text-white">
            <h5 class="mb-0">
                <i class="fa fa-chart-line me-2"></i>Điểm Tổng Kết - Danh Sách Hội Đồng
            </h5>
        </div>
        ...
        <div class="card-body">
            ...
            @if($hoiDongList->isEmpty())
                <div class="text-center py-5">
                    ...
                    <p class="text-muted">Chưa có hội đồng nào được tạo trong hệ thống</p>
                </div>
            @else
                    ...
                    <table class="table table-bordered table-hover align-middle">
                        <thead class="table-light" style="background-color: #f8f9fa;">
                            <tr>
                                ...
                                <th class="text-center" style="width: 12%;">Ngày HĐ</th>
                                <th class="text-center" style="width: 8%;">Đề Tài</th>
                        ...
                        <tbody>
                            @forelse($hoiDongList as $index => $hd)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="{{ route('admin.tong-ket.show', $hd->hoidong_id) }}" 
