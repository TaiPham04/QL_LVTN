            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="alert alert-info">
                        ...
                        <strong>Hướng dẫn:</strong> Dưới đây là danh sách các nhóm sinh viên bạn đang hướng dẫn. 
                        Nhấn vào nút "Chấm điểm" để thực hiện chấm điểm cho nhóm.
                    </div>
                    ...
                    @if($danhSachNhom->isEmpty())
                        <div class="alert alert-warning text-center">
                            ...
                            <h5>Chưa có nhóm nào cần chấm điểm</h5>
                            <p class="mb-0">Hiện tại bạn chưa được phân công hướng dẫn nhóm nào.</p>
                        </div>
                    @else
                            ...
                            <table class="table table-hover table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="{{ route('lecturers.chamdiem.huongdan.form', $nhom->nhom_id) }}" 
                                            ...
                                            @if($nhom->da_cham)
                                                <a href="{{ route('lecturers.chamdiem.huongdan.export', $nhom->nhom_id) }}" 
